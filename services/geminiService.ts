...
4.  Rate the user on the following 5 dimensions on a scale of 0 to 5 (can be decimal): 'Clarity', 'Language Proficiency', 'Conciseness', 'Fluency / Speech Rate', and 'Pauses & Hesitation Markers'. For 'Fluency / Speech Rate', consider the pace and smoothness of speech. For 'Pauses & Hesitation Markers', a higher score indicates fewer and less disruptive pauses.
...
7.  Offer a bulleted list of 3-5 clear, actionable 'feedback' points for improvement. As part of the feedback, specifically mention the user's estimated speech rate in words-per-minute (WPM) and the approximate percentage of speech time occupied by pauses or hesitation markers.
